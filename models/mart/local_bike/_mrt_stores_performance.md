{% docs mrt_stores_performance %}

This dashboard evaluates stores performance at a monthly level by tracking key metrics such as :
- total_turnover : total value sales generated per store
- turnover_contribution : % contribution of the store in value sales
